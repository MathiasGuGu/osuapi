    ...
    const fetchLeaderboard = async () => {
      const response = await fetch("http://localhost:3000/api/GetNorwayBoard", {
        ...
        body: JSON.stringify({
          variant: gamemode,
          bearer:
            "eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9..cDiM2Sz2e_ryt_RJWjE402OJQ4j_5w5NlMiDTFc-rXyE8R5Sx7ep8v_95w3w7DIB7NVUcbYbjCIcwBdkdjCQoVgbQR7kZkXLdByy68U0Yh5e3vFuLdvS19v9R16dQBEdnBJyryCkBYUuxCq8YcG3lo6S6d76f6ossjxz549Lt351DzZu7kIcevJfTM68PJZ5OCi4Gt62CR-Mlo15TQyYBCihSIRtJqqTf7VLoLdUF6Vgoh3hlEYN1JEjy2_hjOvaZYx3ZywwwH68_g2kWlQakmH_KzUCp2y6x6GmNgZGSbJEBQwTGVDyLv1UaWk15bZHcCDRjujT6iLImCfeolsw-fomKJYAJtUn2kpCmlkwQUaIkSlxeGev0ut9x4dkQtMLQMa40wUnavPKeamvxSGfM62_cl-kqr1P4Ps18zkrQl90a_Vyf5FFgpwugDl4ZqeYGYsXRsWssaoHxQH39i-iTvd5BsuPGMlMHzPVCcIISdBfKePQQFCAeA3UuHtoCDnatFuqoDydYPCMAeeg-mwZLax0Ey2F-35DrlOUlHg4q4pYInJWRPg7aX8kwi41E_mUPiBg66dV4Uzcx7R-eqRF_SpGp-evsF2pw8NB6uWWjsGcbYVC2DwpmLgIq84H6cTYqJYt10AW7o-KnbxcK5E7CnEf_oZv6NMUPldaXyXyVXY",
        }),
      });
